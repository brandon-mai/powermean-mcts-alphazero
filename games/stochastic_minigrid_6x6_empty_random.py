...
class Stochastic_MiniGrid_6x6_Empty_Random:
    def __init__(self, reward_scale=10.0):
        self.name = "Stochastic_MiniGrid_6x6_Empty_Random"
        self.num_player = 1 
        
        self.env_id = "MiniGrid-Empty-Random-6x6-v0"
    ...
    def get_next_state(self, state, action):
        ...
        if np.random.rand() < self.randomness:
            legal_moves = [0, 1, 2] # left, right, forward
